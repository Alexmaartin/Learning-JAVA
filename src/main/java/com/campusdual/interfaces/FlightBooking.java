...
public class FlightBooking {
    ...
    public void cancelBook(){
        this.bookedSeat = "";
        System.out.println("Booked successfully cancelled");
    }

    public void getTickerDetail(){
        if (this.bookedSeat.isEmpty()) {
            System.out.println("Flight" + this.flightNumber + "("+ this.company+"), for date" + this.sdf.format(this.bookDate)+ " has a seat booked");
        }else{
